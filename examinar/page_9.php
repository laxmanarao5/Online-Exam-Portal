...
<body>
    <div class="container">
        ...
        <div id="cnode">
    <form action="../admin/server.php" method="POST" class="main-form">
        <label for="name"> Name:</label><input class="input" value="<?php echo $_SESSION['name'];?>" type="text" name="name" id="name">
        <label for="problem">Problem:</label><input class="input" id="problem" type="text" name="problem">
        <label for="desc">Problem Description:</label><textarea name="desc" id="desc" cols="30" rows="10"></textarea>
        <input class="submit" type="submit" name="query" value="submit">
    </form>
        </div>
        </div>
