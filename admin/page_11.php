...
$query="SELECT * FROM `queries` WHERE status=0;";
...
<body>
    <div class="container">
        <div class="nav-bar">
            <a href="page_9.php" title="click here to add new user"><i class="fa fa-question-circle" aria-hidden="true"></i>Queries</a>
            ...
            <div class="table_container">
                ...
                $count++;
                    ...
                    <tr>
                        ...
                        <td class="approve">
                            <a class="button1" href="solve.php?id=<?php echo $row['id']?>">Yes</a>
                            <a class="button2" href="">No</a>
                        </td>
                    </tr>
                    <?php
                }
