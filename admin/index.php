...
<head>
    ...
    <style>
        .admin-examiner-icon,.admin-queries-icon{
    color: #596075;
}
.admin-examiner-icon,.admin-queries-icon{
    padding-left: 35px;
...
<body>
        ...
        <div class="dashboard">
            ...
            <a href="index.php"><i class="fa fa-user admin-students-icon"></i><p style="color:white;">Students</p></a></div></div>  
    ...
    <div class="dashboard_right_container">
        <object type="text/html" class="wd" data="./admin_student_dashboard.html"></object>
    </div>
</div>
