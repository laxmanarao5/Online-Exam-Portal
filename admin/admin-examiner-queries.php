...
<head>
    ...
    <style>
        .admin-students-icon,.admin-examiner-icon{
    color: #596075;
}
.admin-students-icon,.admin-examiner-icon{
    padding-left: 35px;
...
<body>
        ...
        <div class="admin-examiner_dashboard">
            ...
            <a href="admin-examiner.php"><i class="fa fa-user-tie admin-examiner-icon"></i><p>Examiner</p> </a></div></div>
            ...
            <a href="admin-examiner-queries.php"><i class="fa fa-comment-dots admin-queries-icon"></i><p style="color:white;">Queries</p> </a></div></div>
            <!-- <a href=""><i class="fa fa-dashboard dashboard-icon"></i><p>Settings</p></a> -->
            </div>
            </div>
            <div class="dashboard_right_container">
                <object type="text/html" class="wd" data="./page_9.php"></object>
            </div>
